...
export function SelectDocumentation() {
  ...
  return (
    <ComponentPage
      contentClassName="select-docs-content"
      ...
      metadata={["@lenso/ui/select", "Registry ready"]}
      name="Select"
      slug="select"
    >
      <LivePlayground
      ...
      <section className="button-guidance select-guidance">
        ...
        <article>
          ...
          <ul>
            <li>
              Keyboard navigation, selection, dismissal, and focus restoration are provided by Base
              UI.
            </li>
          </ul>
        </article>
